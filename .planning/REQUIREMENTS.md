...
- [ ] **TECH-04**: `test_ingest.py` patcht `OllamaEmbeddings` (nicht `OpenAIEmbeddings`) – CI testet den tatsächlichen Embedding-Pfad
...
Welche Phasen welche Requirements abdecken. Wird beim Roadmap-Schritt befüllt.
